                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['menu']; ?></td>
                            <td>
                                <a href="<?= base_url('menu/update_menu/' . $m['id']); ?>" class="btn btn-success">Update</a>
                                <a href="<?= base_url('menu/delete_menu/' . $m['id']); ?>" onclick="return confirm('Apakah Anda yakin mau menghapus Kategori Ini?');" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
